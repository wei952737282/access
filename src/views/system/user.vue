      ...
      <div class="condition-groups">
        <div class="condition-box">
          ...
          <div class="condition-val">
            <el-input style="width: 80%" v-model="condition.mjxlh" placeholder="请输入用户账号"></el-input>
          </div>
        </div>
        <div class="condition-box">
          <div class="condition-title">手机号码：</div>
          <div class="condition-val">
            <el-input style="width: 80%" v-model="condition.mjxlh" placeholder="请输入手机号码"></el-input>
          </div>
        </div>
        <div class="condition-box">
          <div class="condition-title">角色名称：</div>
          <div class="condition-val">
            <el-input style="width: 80%" v-model="condition.mjxlh" placeholder="请输入角色名称"></el-input>
          </div>
        </div>
        <div class="condition-box">
