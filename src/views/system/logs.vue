  ...
  <div class="app-container">
      <div class="condition-groups">
        <div class="condition-box">
          <div class="condition-title">操作人员：</div>
          <div class="condition-val">
            <el-input
              style="width: 80%" v-model="condition.mjxlh" placeholder="请输入操作人员"></el-input>
          </div>
        </div>
        <div class="condition-box">
        ...
        <div class="condition-box">
          <div class="condition-title">系统模块：</div>
          <div class="condition-val">
            <el-select
              style="width: 80%" v-model="condition.kqz.value" placeholder="请选择系统模块">
              <el-option
        ...
        <div class="condition-box">
          <div class="condition-title">操作类型：</div>
          <div class="condition-val">
            <el-select  style="width: 80%" v-model="condition.mjzt.value" placeholder="请选择操作类型：" >
              <el-option
        ...
        <div class="condition-box">
          ...
          <div class="condition-val">
            <el-select  style="width: 80%" v-model="condition.mjzt.value" placeholder="状态：" >
              <el-option
                v-for="item in condition.mjzt.options"
                :key="item.value"
                :label="item.label"
