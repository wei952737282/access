  ...
  <div class="app-container">
      <div class="condition-groups">
        <div class="condition-box">
          <div class="condition-title">用户类型：</div>
          <div class="condition-val">
            <el-select
              style="width: 80%" v-model="condition.ld.value" placeholder="请选择用户类型">
              <el-option
        ...
        <div class="condition-box">
          <div class="condition-title">用户名称：</div>
          <div class="condition-val">
            <el-input
              style="width: 80%" v-model="condition.mjxlh" placeholder="请输入用户名称"></el-input>
          </div>
        </div>
        <div class="condition-box">
        ...
        <div class="condition-box">
          ...
          <div class="condition-val">
            <el-select
              style="width: 80%" v-model="condition.fk_type.value" placeholder="请选择访客类型">
              <el-option
        ...
        <div class="condition-box">
          <div class="condition-title">开门楼栋：</div>
          <div class="condition-val">
            <el-select
              style="width: 80%" v-model="condition.lc.value" placeholder="请选择开门楼栋">
              <el-option
        ...
        <div class="condition-box">
          <div class="condition-title">开门类型：</div>
          <div class="condition-val">
            <el-select  style="width: 80%" v-model="condition.mjzt.value" placeholder="请选择开门类型：" >
              <el-option
